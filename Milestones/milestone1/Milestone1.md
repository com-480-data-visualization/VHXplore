...
Our goal is to stand out from the project listed above by making visualization that are atypical and have not been done before. We would also like to stand out by decidding to select visualization that are normally not put together in one single web page.
Finally, we would like to stand out from the projecst above by putting the emphasis on making interactive, fluid and artistically orginal and visually pleasing visualizations. 
...
We have been inspired by the [Bolo museum](https://en.wikipedia.org/wiki/Mus%C3%A9e_Bolo) at EPFL. What we would like to do is to have a similar approach: we would like to make it fun to learn about technology in an interactive way and for people with any level of tech expertise.
